...
//     const { fullName, emailAddress, estimate, yardSize, serviceFrequency, addOns, streetAddress, city, propertyCondition, additionalNotes, photos } = data;
...
//           .estimate { font-size: 32px; font-weight: bold; color: #667eea; }
...
//           <div class="content">
//             <p>Hi ${fullName},</p>
//             <p>Thank you for requesting a quote! Based on the information you provided, here's your estimate:</p>

//             <div class="quote-box">
//               <p style="margin: 0; color: #666;">Estimated Total</p>
//               <div class="estimate">$${estimate.min} – $${estimate.max}</div>
//               <p style="margin: 10px 0 0 0; font-size: 14px; color: #999;">Final pricing may vary based on site inspection</p>
//             </div>

//             <h3>Quote Details</h3>
//             <div class="detail-row">
//               <span class="label">Property Address:</span> ${streetAddress}, ${city}
//             </div>
//             <div class="detail-row">
//               <span class="label">Yard Size:</span> ${yardSize.charAt(0).toUpperCase() + yardSize.slice(1)}
//             </div>
//             <div class="detail-row">
//               <span class="label">Service Frequency:</span> ${serviceFrequency.charAt(0).toUpperCase() + serviceFrequency.slice(1)}
//             </div>
//             <div class="detail-row">
//               <span class="label">Property Condition:</span> ${propertyCondition.charAt(0).toUpperCase() + propertyCondition.slice(1)}
//             </div>
//             <div class="detail-row">
//               <span class="label">Add-on Services:</span> ${addOnsList}
//             </div>
//             <div class="detail-row">
//               <span class="label">Photos Uploaded:</span> ${photoCount} photo(s)
//             </div>
//             ${additionalNotes ? `
//             <div class="detail-row">
...
//               Our team will review your photos and details. We'll contact you within 24 hours to confirm the final quote and schedule your service.
//             </p>

//             <p>If you have any questions, feel free to reply to this email or call us.</p>

//             <p>Best regards,<br/>
//             <strong>Lawn Care Team</strong></p>
//           </div>
//           <div class="footer">
//             <p>This is an automated quote. Final pricing subject to site inspection.</p>
//           </div>
//         </div>
//       </body>
//     </html>
...
//             from: 'Lawn Care <onboarding@resend.dev>', // Replace with your verified domain
//             to: emailAddress,
//             subject: `Your Lawn Care Quote: $${estimate.min}–$${estimate.max}`,
//             html: htmlContent,
//         });

//         // Also send to business email for tracking
//         await resend.emails.send({
