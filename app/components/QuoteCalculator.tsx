...
//   const [estimate, setEstimate] = useState({ min: 70, max: 100 });
...
//       addOns: checked
//         ? [...prev.addOns, value]
//         : prev.addOns.filter((addon: any) => addon !== value),
//     }));
//   };
...
//               required
//               className="bg-gray-700 text-white px-4 py-3 rounded border border-gray-600 focus:border-blue-500 focus:outline-none"
//             />
//             <input
//               type="tel"
//               name="phoneNumber"
...
//               type="text"
//               name="streetAddress"
//               placeholder="Street address (Address/Apartment/Suite)"
...
//                 id: "small",
//                 label: "Small yard",
//                 desc: "Townhouse / semi-detached, up to ~2,000 sq ft",
//                 price: "$50–$70",
//               },
//               {
//                 id: "medium",
...
//                 id: "large",
//                 label: "Large yard",
//                 desc: "Large lot / corner lot, 5,000+ sq ft",
//                 price: "$100–$140",
//               },
//             ].map((yard) => (
//               <label
...
//                     {yard.label}
//                   </h3>
//                   <p className="text-gray-400 text-sm mt-1">{yard.desc}</p>
//                   <p className="text-white font-bold text-lg mt-2">
//                     {yard.price}
//                   </p>
//                   <p className="text-gray-500 text-xs">per cut</p>
//                 </div>
//               </label>
//             ))}
//           </div>
...
//               { id: "weekly", label: "Weekly", discount: "10% off" },
//               { id: "biweekly", label: "Bi-weekly", discount: "5% off" },
//             ].map((freq) => (
//               <label
//                 key={freq.id}
...
//                   value={freq.id}
//                   checked={formData.serviceFrequency === freq.id}
//                   onChange={handleInputChange}
//                   className="sr-only"
//                 />
...
//               },
//               {
//                 id: "garden-bed-weeding",
//                 label: "Garden bed weeding",
//                 price: "+$15–$30",
//               },
//               { id: "leaf-removal", label: "Leaf removal", price: "+$30–$60" },
//             ].map((addon) => (
//               <label
//                 key={addon.id}
//                 className="flex items-center justify-between p-4 rounded-lg bg-gray-700 border border-gray-600 hover:border-gray-500 cursor-pointer transition"
//               >
...
//             <option value="overgrown">Overgrown (requires extra work)</option>
...
//             className="block w-full p-8 border-2 border-dashed border-gray-600 rounded-lg text-center cursor-pointer hover:border-blue-500 transition"
//           >
//             <svg
...
//               />
//             </svg>
//             <p className="text-gray-400 mt-2">Click to upload yard photos</p>
//           </label>
...
//                 Estimated Total
//               </h3>
//               <p className="text-gray-400 text-sm">Final quote after review</p>
//             </div>
...
//           className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 text-white font-semibold py-4 rounded-lg transition"
//         >
//           {isSubmitting ? "Submitting..." : "Get Final Quote"}
//         </button>

//         {/* Status Messages */}
//         {submitStatus === "success" && (
//           <div className="bg-green-900/50 border border-green-700 text-green-400 p-4 rounded-lg text-center">
//             ✓ Quote sent successfully! Check your email.
//           </div>
//         )}
//         {submitStatus === "error" && (
//           <div className="bg-red-900/50 border border-red-700 text-red-400 p-4 rounded-lg text-center">
          ...
          <div className="bg-[#1a1a1a] border border-gray-800 rounded-lg p-5 space-y-3">
            ...
            <div className="border-t border-gray-800 pt-3">
              <div className="flex justify-between items-center">
                ...
                <div className="basis-[135px] w-1/2 sm:w-auto sm:basis-1/3  text-right">
                  <p className="text-green-400 sm:text-3xl text-xl  font-bold">
